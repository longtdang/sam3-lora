...
def test_visualize_flag_calls_visualize_coco_output(categories_coco_file, tmp_path):
    """--visualize flag must call visualize_coco_output with correct args."""
    import infer_folder_coco
    
    # Setup image directory and files
    img = PILImage.new("RGB", (50, 50), color=(100, 100, 100))
    ...
    # Mock visualize_coco_output function
    mock_visualize = MagicMock()
    
    # Mock sys.argv with --visualize flag
    test_argv = [
        "infer_folder_coco.py",
        "--input-dir", input_dir,
        "--output", output_json,
    ...
    # Verify visualize_coco_output was called once
    mock_visualize.assert_called_once()
    
    # Verify it was called with the correct arguments:
    # (output_json, input_dir, viz_dir)
    call_args = mock_visualize.call_args[0]
    assert call_args[0] == output_json
    assert call_args[1] == input_dir
    assert call_args[2].endswith("_viz")
